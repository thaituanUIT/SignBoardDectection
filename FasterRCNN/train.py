...
class SignboardsDataset(torch.utils.data.Dataset):

	""" The dataset contains images of signboards. 
		The dataset includes images of signboards and a csv file with annotations."""
...
if __name__ == '__main__':
	...
	labels_dict = create_label_txt("datasets/train/_annotations.csv")

	# Define train and test dataset
	dataset = SignboardsDataset(dataset_dir = "datasets/train/", csv_file = "datasets/train/_annotations.csv",
							labels_dict = labels_dict, transforms = get_transforms(train = True))

	dataset_test = SignboardsDataset(dataset_dir = "datasets/train/", csv_file = "datasets/train/_annotations.csv", 
	...
	model_save_path = os.path.join(output_dir, f"faster_rcnn_model_{timestamp}.pth")
